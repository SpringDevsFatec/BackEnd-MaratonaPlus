...
INSERT INTO maratona (criador, nome, local, data_inicio, data_final, distancia, status, descricao, regras, limite_participantes, valor, tipo_terreno, clima_esperado) VALUES (6, 'Gustavo Maratonas I', 'Belo Horizonte, MG', '2024-09-07', '2024-10-07', '42.195', 'ABERTA_PARA_INSCRICAO', 'Celebre a história do Brasil com a Maratona da Independência', 'Uso obrigatório de chip.', 10,120.00, 'Asfalto', 'Quente');
INSERT INTO maratona (criador, nome, local, data_inicio, data_final, distancia, status, descricao, regras, limite_participantes, valor, tipo_terreno, clima_esperado) VALUES (6, 'Gustavo Maratonas II', 'São Paulo, SP', '2024-09-07', '2024-10-07', '42.195', 'CANCELADA', 'Celebre a história do Brasil com a Maratona da Independência', 'Uso obrigatório de chip.', 10,120.00, 'Asfalto', 'Quente');
